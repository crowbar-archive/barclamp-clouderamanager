...
default[:clouderamanager][:hdfs][:dfs_access_port] = "8020"
...
default[:clouderamanager][:hdfs][:dfs_access_time_precision] = "3600000"
...
default[:clouderamanager][:hdfs][:dfs_balance_bandwidthPerSec] = "1048576"

# Interval in minutes at which namenode updates its access keys.
default[:clouderamanager][:hdfs][:dfs_block_access_key_update_interval] = "600"

# If "true", access tokens are used as capabilities for accessing
# datanodes. If "false", no access tokens are checked on accessing
# datanodes.
default[:clouderamanager][:hdfs][:dfs_block_access_token_enable] = "false"

# The lifetime of access tokens in minutes.
default[:clouderamanager][:hdfs][:dfs_block_access_token_lifetime] = "600"

# The default block size for new files.
default[:clouderamanager][:hdfs][:dfs_block_size] = "134217728"

# Delay for first block report in seconds.
default[:clouderamanager][:hdfs][:dfs_blockreport_initialDelay] = ""

# Determines block reporting interval in milliseconds.
default[:clouderamanager][:hdfs][:dfs_blockreport_intervalMsec] = "3600000"

# The number of retries for writing blocks to the data nodes, before we
# signal failure to the application.
default[:clouderamanager][:hdfs][:dfs_client_block_write_retries] = "3"
...
default[:clouderamanager][:hdfs][:dfs_data_dir] = [ "/mnt/hdfs/hdfs01/data1" ]

# The address where the datanode server will listen to. If the port is 0
# then the server will start on a free port.
default[:clouderamanager][:hdfs][:dfs_datanode_address] = "0.0.0.0:50010"
...
# symbolic.
default[:clouderamanager][:hdfs][:dfs_datanode_data_dir_perm] = "755"

# The name of the Network Interface from which a data node should report
# its IP address.
default[:clouderamanager][:hdfs][:dfs_datanode_dns_interface] = "default"
...
default[:clouderamanager][:hdfs][:dfs_datanode_dns_nameserver] = "default"

# Reserved space in bytes per volume. Always leave this much space free for
# non dfs use.
default[:clouderamanager][:hdfs][:dfs_datanode_du_reserved] = "10737418240"
...
# shutdown.
default[:clouderamanager][:hdfs][:dfs_datanode_failed_volumes_tolerated] = ""

# The number of server threads for the datanode.
default[:clouderamanager][:hdfs][:dfs_datanode_handler_count] = "16"

# The datanode http server address and port. If the port is 0 then the
# server will start on a free port.
default[:clouderamanager][:hdfs][:dfs_datanode_http_address] = "0.0.0.0:50075"

default[:clouderamanager][:hdfs][:dfs_datanode_https_address] = "0.0.0.0:50475"

# The datanode ipc server address and port. If the port is 0 then the
# server will start on a free port.
default[:clouderamanager][:hdfs][:dfs_datanode_ipc_address] = "0.0.0.0:50020"

# The number of bytes to view for a file on the browser.
default[:clouderamanager][:hdfs][:dfs_default_chunk_view_size] = "32768"

# Disk usage statistics refresh interval in msec.
default[:clouderamanager][:hdfs][:dfs_df_interval] = "60000"

# Determines datanode heartbeat interval in seconds.
default[:clouderamanager][:hdfs][:dfs_heartbeat_interval] = "3"
...
default[:clouderamanager][:hdfs][:dfs_hosts] = ""
...
default[:clouderamanager][:hdfs][:dfs_hosts_exclude] = ""
...
default[:clouderamanager][:hdfs][:dfs_http_address] = "0.0.0.0:50070"
default[:clouderamanager][:hdfs][:dfs_https_address] = "0.0.0.0:50470"

# Resource file from which ssl client keystore information will be
# extracted.
default[:clouderamanager][:hdfs][:dfs_https_client_keystore_resource] = "ssl-client.xml"

# Decide if HTTPS(SSL) is supported on HDFS.
default[:clouderamanager][:hdfs][:dfs_https_enable] = "false"

# Whether SSL client certificate authentication is required.
default[:clouderamanager][:hdfs][:dfs_https_need_client_auth] = "false"

# Resource file from which ssl server keystore information will be
# extracted.
default[:clouderamanager][:hdfs][:dfs_https_server_keystore_resource] = "ssl-server.xml"
...
default[:clouderamanager][:hdfs][:dfs_max_objects] = ""
...
default[:clouderamanager][:hdfs][:dfs_name_dir] = [ "/mnt/hdfs/hdfs01/meta1" ]
...
default[:clouderamanager][:hdfs][:dfs_name_edits_dir] = [ "/mnt/hdfs/hdfs01/meta1" ]

# Namenode periodicity in seconds to check if decommission is complete.
default[:clouderamanager][:hdfs][:dfs_namenode_decommission_interval] = "30"

# The number of nodes namenode checks if decommission is complete in each
# dfs.namenode.decommission.interval.
default[:clouderamanager][:hdfs][:dfs_namenode_decommission_nodes_per_interval] = "5"

# The update interval for master key for delegation tokens in the namenode
# in milliseconds.
default[:clouderamanager][:hdfs][:dfs_namenode_delegation_key_update_interval] = "86400000"

# The maximum lifetime in milliseconds for which a delegation token is
# valid.
default[:clouderamanager][:hdfs][:dfs_namenode_delegation_token_max_lifetime] = "604800000"

# The renewal interval for delegation token in milliseconds.
default[:clouderamanager][:hdfs][:dfs_namenode_delegation_token_renew_interval] = "86400000"

# The number of server threads for the namenode.
default[:clouderamanager][:hdfs][:dfs_namenode_handler_count] = "32"
...
default[:clouderamanager][:hdfs][:dfs_namenode_logging_level] = "info"
...
default[:clouderamanager][:hdfs][:dfs_permissions] = "true"

# The name of the group of super-users.
default[:clouderamanager][:hdfs][:dfs_permissions_supergroup] = "supergroup"
...
default[:clouderamanager][:hdfs][:dfs_replication] = "3"

# Decide if chooseTarget considers the target's load or not.
default[:clouderamanager][:hdfs][:dfs_replication_considerLoad] = "true"

# The periodicity in seconds with which the namenode computes repliaction
# work for datanodes.
default[:clouderamanager][:hdfs][:dfs_replication_interval] = "3"

# Maximal block replication.
default[:clouderamanager][:hdfs][:dfs_replication_max] = "512"

# Minimal block replication.
default[:clouderamanager][:hdfs][:dfs_replication_min] = "1"

# Determines extension of safe mode in milliseconds after the threshold
# level is reached.
default[:clouderamanager][:hdfs][:dfs_safemode_extension] = "30000"
...
default[:clouderamanager][:hdfs][:dfs_safemode_threshold_pct] = "0.999f"

# The secondary namenode http server address and port. If the port is 0
# then the server will start on a free port.
default[:clouderamanager][:hdfs][:dfs_secondary_http_address] = "0.0.0.0:50090"
...
# cluster.
default[:clouderamanager][:hdfs][:dfs_support_append] = "false"

# The user account used by the web interface. Syntax:
# USERNAME,GROUP1,GROUP2, ...
default[:clouderamanager][:hdfs][:dfs_web_ugi] = "webuser,webgroup"
