...
default[:clouderamanager][:mapred][:hadoop_job_history_location] = ""
...
default[:clouderamanager][:mapred][:hadoop_job_history_user_location] = ""
...
default[:clouderamanager][:mapred][:hadoop_rpc_socket_factory_class_JobSubmissionProtocol] = ""
...
# seeks.
default[:clouderamanager][:mapred][:io_sort_mb] = "512"
...
default[:clouderamanager][:mapred][:io_sort_record_percent] = "0.05"
...
default[:clouderamanager][:mapred][:io_sort_spill_percent] = "0.80"

# Indicates how many times hadoop should attempt to contact the
# notification URL.
default[:clouderamanager][:mapred][:job_end_retry_attempts] = ""

# Indicates time in milliseconds between notification URL retry calls.
default[:clouderamanager][:mapred][:job_end_retry_interval] = "30000"
...
default[:clouderamanager][:mapred][:jobclient_output_filter] = "FAILED"
...
# they are consumed.
default[:clouderamanager][:mapred][:keep_failed_task_files] = "false"

# The default sort class for sorting keys.
default[:clouderamanager][:mapred][:map_sort_class] = "org.apache.hadoop.util.QuickSort"
...
default[:clouderamanager][:mapred][:mapred_acls_enabled] = "false"
...
default[:clouderamanager][:mapred][:mapred_child_env] = ""
...
default[:clouderamanager][:mapred][:mapred_child_java_opts] = "-Xmx1024m"
...
# dir'.
default[:clouderamanager][:mapred][:mapred_child_tmp] = "./tmp"
...
# might not start.
default[:clouderamanager][:mapred][:mapred_child_ulimit] = "2097152"
...
default[:clouderamanager][:mapred][:mapred_cluster_map_memory_mb] = "-1"
...
default[:clouderamanager][:mapred][:mapred_cluster_max_map_memory_mb] = "-1"
...
default[:clouderamanager][:mapred][:mapred_cluster_max_reduce_memory_mb] = "-1"
...
default[:clouderamanager][:mapred][:mapred_healthChecker_script_path] = ""

# Time after node health script should be killed if unresponsive and
# considered that the script has failed.
default[:clouderamanager][:mapred][:mapred_healthChecker_script_timeout] = "600000"
...
default[:clouderamanager][:mapred][:mapred_heartbeats_in_second] = "100"
...
default[:clouderamanager][:mapred][:mapred_hosts] = ""
...
default[:clouderamanager][:mapred][:mapred_hosts_exclude] = ""
...
default[:clouderamanager][:mapred][:mapred_inmem_merge_threshold] = "1000"
...
# next multiple of mapred.cluster.map.memory.mb and up to the limit
# specified by mapred.cluster.max.map.memory.mb, if the scheduler supports
# the feature. The value of -1 indicates that this feature is turned off
# iff mapred.cluster.map.memory.mb is also turned off (-1).
default[:clouderamanager][:mapred][:mapred_job_map_memory_mb] = "-1"
...
default[:clouderamanager][:mapred][:mapred_job_queue_name] = "default"
...
default[:clouderamanager][:mapred][:mapred_job_reduce_input_buffer_percent] = "0.0"
...
default[:clouderamanager][:mapred][:mapred_job_reduce_memory_mb] = "-1"

# How many tasks to run per jvm. If set to -1, there is no limit.
default[:clouderamanager][:mapred][:mapred_job_reuse_jvm_num_tasks] = "1"

# The percentage of memory to be allocated from the maximum heap size to
# storing map outputs during the shuffle.
default[:clouderamanager][:mapred][:mapred_job_shuffle_input_buffer_percent] = "0.70"
...
default[:clouderamanager][:mapred][:mapred_job_shuffle_merge_percent] = "0.66"
...
default[:clouderamanager][:mapred][:mapred_job_tracker] = "local"

# The number of server threads for the JobTracker. This should be roughly
# 4% of the number of tasktracker nodes.
default[:clouderamanager][:mapred][:mapred_job_tracker_handler_count] = "32"
...
default[:clouderamanager][:mapred][:mapred_job_tracker_history_completed_location] = ""

# The job tracker http server address and port the server will listen on.
# If the port is 0 then the server will start on a free port.
default[:clouderamanager][:mapred][:mapred_job_tracker_http_address] = "0.0.0.0:50030"
...
default[:clouderamanager][:mapred][:mapred_job_tracker_jobhistory_lru_cache_size] = "5"

# Indicates if persistency of job status information is active or not.
default[:clouderamanager][:mapred][:mapred_job_tracker_persist_jobstatus_active] = "false"
...
# jobtracker restarts.
default[:clouderamanager][:mapred][:mapred_job_tracker_persist_jobstatus_dir] = "/jobtracker/jobsInfo"
...
default[:clouderamanager][:mapred][:mapred_job_tracker_persist_jobstatus_hours] = ""

# The number of retired job status to keep in the cache.
default[:clouderamanager][:mapred][:mapred_job_tracker_retiredjobs_cache_size] = "1000"
...
default[:clouderamanager][:mapred][:mapred_jobtracker_blacklist_fault_bucket_width] = "15"
...
default[:clouderamanager][:mapred][:mapred_jobtracker_blacklist_fault_timeout_window] = "180"

# The maximum number of complete jobs per user to keep around before
# delegating them to the job history.
default[:clouderamanager][:mapred][:mapred_jobtracker_completeuserjobs_maximum] = "100"
...
# 3 MB.
default[:clouderamanager][:mapred][:mapred_jobtracker_job_history_block_size] = "3145728"

# The maximum number of tasks for a single job. A value of -1 indicates
# that there is no maximum.
default[:clouderamanager][:mapred][:mapred_jobtracker_maxtasks_per_job] = "-1"

# "true" to enable (job) recovery upon restart, "false" to start afresh.
default[:clouderamanager][:mapred][:mapred_jobtracker_restart_recover] = "false"

# The class responsible for scheduling the tasks.
default[:clouderamanager][:mapred][:mapred_jobtracker_taskScheduler] = "org.apache.hadoop.mapred.JobQueueTaskScheduler"

# The maximum number of running tasks for a job before it gets preempted.
# No limits if undefined.
default[:clouderamanager][:mapred][:mapred_jobtracker_taskScheduler_maxRunningTasksPerJob] = ""

# Number of lines per split in NLineInputFormat.
default[:clouderamanager][:mapred][:mapred_line_input_format_linespermap] = "1"
...
default[:clouderamanager][:mapred][:mapred_local_dir] = [ "/var/lib/hadoop-0.20/cache/mapred/mapred/local" ]
...
default[:clouderamanager][:mapred][:mapred_local_dir_minspacekill] = ""

# If the space in mapred.local.dir drops under this, do not ask for more
# tasks. Value in bytes.
default[:clouderamanager][:mapred][:mapred_local_dir_minspacestart] = ""
...
default[:clouderamanager][:mapred][:mapred_map_max_attempts] = "4"

# If the map outputs are compressed, how should they be compressed?.
default[:clouderamanager][:mapred][:mapred_map_output_compression_codec] = "org.apache.hadoop.io.compress.DefaultCodec"

# The default number of map tasks per job. Ignored when mapred.job.tracker
# is "local".
default[:clouderamanager][:mapred][:mapred_map_tasks] = "2"

# If true, then multiple instances of some map tasks may be executed in
# parallel.
default[:clouderamanager][:mapred][:mapred_map_tasks_speculative_execution] = "false"
...
# this setting.
default[:clouderamanager][:mapred][:mapred_min_split_size] = ""

# Should the job outputs be compressed?.
default[:clouderamanager][:mapred][:mapred_output_compress] = "false"

# If the job outputs are compressed, how should they be compressed?.
default[:clouderamanager][:mapred][:mapred_output_compression_codec] = "org.apache.hadoop.io.compress.DefaultCodec"

# If the job outputs are to compressed as SequenceFiles, how should they be
# compressed? Should be one of NONE, RECORD or BLOCK.
default[:clouderamanager][:mapred][:mapred_output_compression_type] = "RECORD"
...
default[:clouderamanager][:mapred][:mapred_queue_default_state] = "RUNNING"
...
default[:clouderamanager][:mapred][:mapred_queue_names] = "default"

# The maximum amount of time (in seconds) a reducer spends on fetching one
# map output before declaring it as failed.
default[:clouderamanager][:mapred][:mapred_reduce_copy_backoff] = "300"
...
# before giving up on it.
default[:clouderamanager][:mapred][:mapred_reduce_max_attempts] = "4"

# The default number of parallel transfers run by reduce during the
# copy(shuffle) phase.
default[:clouderamanager][:mapred][:mapred_reduce_parallel_copies] = "5"

# Fraction of the number of maps in the job which should be complete before
# reduces are scheduled for the job.
default[:clouderamanager][:mapred][:mapred_reduce_slowstart_completed_maps] = "0.05"
...
default[:clouderamanager][:mapred][:mapred_reduce_tasks] = "6"

# If true, then multiple instances of some reduce tasks may be executed in
# parallel.
default[:clouderamanager][:mapred][:mapred_reduce_tasks_speculative_execution] = "false"
...
# those are skipped.
default[:clouderamanager][:mapred][:mapred_skip_attempts_to_start_skipping] = "2"
...
default[:clouderamanager][:mapred][:mapred_skip_map_auto_incr_proc_count] = "true"
...
# acceptable.
default[:clouderamanager][:mapred][:mapred_skip_map_max_skip_records] = ""
...
default[:clouderamanager][:mapred][:mapred_skip_out_dir] = ""
...
default[:clouderamanager][:mapred][:mapred_skip_reduce_auto_incr_proc_count] = "true"
...
default[:clouderamanager][:mapred][:mapred_skip_reduce_max_skip_groups] = ""

# The replication level for submitted job files. This should be around the
# square root of the number of nodes.
default[:clouderamanager][:mapred][:mapred_submit_replication] = "10"

# The directory where MapReduce stores control files (/mapred/system).
default[:clouderamanager][:mapred][:mapred_system_dir] = "/mapred/system"
...
default[:clouderamanager][:mapred][:mapred_task_cache_levels] = "2"
...
default[:clouderamanager][:mapred][:mapred_task_timeout] = "600000"

# The task tracker http server address and port. If the port is 0 then the
# server will start on a free port.
default[:clouderamanager][:mapred][:mapred_task_tracker_http_address] = "0.0.0.0:50060"
...
default[:clouderamanager][:mapred][:mapred_task_tracker_report_address] = "127.0.0.1:0"

# TaskController which is used to launch and manage task execution.
default[:clouderamanager][:mapred][:mapred_task_tracker_task_controller] = "org.apache.hadoop.mapred.DefaultTaskController"

# The name of the Network Interface from which a task tracker should report
# its IP address.
default[:clouderamanager][:mapred][:mapred_tasktracker_dns_interface] = "default"
...
default[:clouderamanager][:mapred][:mapred_tasktracker_memory_calculator_plugin] = ""

# The maximum number of reduce tasks that will be run simultaneously by a
# task tracker.
default[:clouderamanager][:mapred][:mapred_tasktracker_reduce_tasks_maximum] = "6"
...
default[:clouderamanager][:mapred][:mapred_tasktracker_taskmemorymanager_monitoring_interval] = "5000"

# The time, in milliseconds, the tasktracker waits for sending a SIGKILL to
# a process, after it has been sent a SIGTERM.
default[:clouderamanager][:mapred][:mapred_tasktracker_tasks_sleeptime_before_sigkill] = "5000"

# A shared directory for temporary files.
# DEFAULT : ${hadoop.tmp.dir}/mapred/temp
default[:clouderamanager][:mapred][:mapred_temp_dir] = "/mnt/hdfs/hdfs01/data1/mapred/temp"

# The maximum allowed size of the user jobconf. The default is set to 5 MB.
default[:clouderamanager][:mapred][:mapred_user_jobconf_limit] = "5242880"

# The maximum size of user-logs of each task in KB. 0 disables the cap.
default[:clouderamanager][:mapred][:mapred_userlog_limit_kb] = ""

# The maximum time, in hours, for which the user-logs are to be retained
# after the job completion.
default[:clouderamanager][:mapred][:mapred_userlog_retain_hours] = "24"
...
# operations on a job.
default[:clouderamanager][:mapred][:mapreduce_job_acl_modify_job] = ""
...
default[:clouderamanager][:mapred][:mapreduce_job_acl_view_job] = ""

# if false - do not unregister/cancel delegation tokens from renewal,
# because same tokens may be used by spawned jobs.
default[:clouderamanager][:mapred][:mapreduce_job_complete_cancel_delegation_tokens] = "true"

# Limit on the number of counters allowed per job.
default[:clouderamanager][:mapred][:mapreduce_job_counters_limit] = "120"
...
default[:clouderamanager][:mapred][:mapreduce_job_split_metainfo_maxsize] = "10000000"
...
default[:clouderamanager][:mapred][:mapreduce_jobtracker_staging_root_dir] = "/mnt/hdfs/hdfs01/data1/mapred/staging"
...
default[:clouderamanager][:mapred][:mapreduce_reduce_input_limit] = "-1"
...
default[:clouderamanager][:mapred][:mapreduce_reduce_shuffle_connect_timeout] = "180000"
...
# connection.
default[:clouderamanager][:mapred][:mapreduce_reduce_shuffle_read_timeout] = "180000"
...
default[:clouderamanager][:mapred][:mapreduce_tasktracker_group] = ""

# Expert: Set this to true to let the tasktracker send an out-of-band
# heartbeat on task-completion for better latency.
default[:clouderamanager][:mapred][:mapreduce_tasktracker_outofband_heartbeat] = "false"

# The number of worker threads that for the http server. This is used for
# map output fetching.
default[:clouderamanager][:mapred][:tasktracker_http_threads] = "40"
