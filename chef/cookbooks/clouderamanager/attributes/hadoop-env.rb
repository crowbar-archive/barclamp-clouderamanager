...
default[:clouderamanager][:env][:hadoop_datanode_opts] = ""
...
# 1000.
default[:clouderamanager][:env][:hadoop_heapsize] = "1000"

# Command line configuration options for the jobtracker.
default[:clouderamanager][:env][:hadoop_jobtracker_opts] = "-Xmx2048m"

# Command line configuration options for the balancer.
default[:clouderamanager][:env][:hadoop_balancer_opts] = "-Xmx2048m"

# The directory where the daemons log files are stored. They are
# automatically created if they don't already exist.
default[:clouderamanager][:env][:hadoop_log_dir] = "/var/log/hadoop"

# Command line configuration options for the primary name node.
default[:clouderamanager][:env][:hadoop_namenode_opts] = "-Xmx2048m"

# Command line configuration options for the secondary name node.
default[:clouderamanager][:env][:hadoop_secondarynamenode_opts] = "-Xmx2048m"

# Command line configuration options for the tasktracker.
default[:clouderamanager][:env][:hadoop_tasktracker_opts] = "-Xmx2048m"
