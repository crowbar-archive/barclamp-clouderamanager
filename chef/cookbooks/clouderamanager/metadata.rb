...
version          "1.0"
recipe           "clouderamanager::cm-agent", "Installs the Cloudera Manager agent packages."
recipe           "clouderamanager::cm-common", "Installs Cloudera Manager common components."
recipe           "clouderamanager::cm-ha-filer", "Installs the Hadoop High Availability filer component."
...
recipe           "clouderamanager::postgresql", "Installs the PostgreSQL server for Cloudera Manager meta data store."
