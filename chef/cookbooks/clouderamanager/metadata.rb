...
recipe           "clouderamanager::masternamenode", "Installs the master name node package and prepares the file system."
recipe           "clouderamanager::secondarynamenode", "Installs the secondary name node package and prepares the file system."
recipe           "clouderamanager::slavenode", "Installs the slave node and task tracker packages and prepares the file system."
recipe           "clouderamanager::edgenode", "Installs the edge node and task tracker packages and prepares the file system."
